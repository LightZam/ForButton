...
public class Suggest implements Dictionary.WordCallback {
    ...
    public List<CharSequence> getSuggestions(View view, WordComposer wordComposer, 
        ...
        Log.d("Test", "wordComposer.getTypedWord() " + wordComposer.getTypedWord());
        Log.d("Test", "wordComposer.size() " + wordComposer.size());
        ...
        */
        ...
        while (i < mSuggestions.size() && i < max) {
            ...
            if (canAdd) {
            	Log.d("Test", "canAdd: mSuggestions[" + i + "]" + mSuggestions.get(i));
                mHaveCorrection = true;
                mSuggestions.add(i + 1, autoText);
                i++;
            }
//            Log.d("Test", "mSuggestions[" + i + "]" + mSuggestions.get(i));
            i++;
        }
        Log.d("Test", "return mSuggestions " + mSuggestions);
        return mSuggestions;
    }
     ...
     * */
    public List<CharSequence> getAssociations(View view, WordComposer wordComposer, String selectedWord, int index){
        Arrays.fill(mPriorities, 0);
        collectGarbage();
//        if (wordComposer.size() > 0) {
	    	if (mUserDictionary != null) {
	    		mUserDictionary.getWordAssociation(wordComposer,this,selectedWord,index);
	    	}
//        }
		return mSuggestions;
    }
...
//            	Log.d("Test", "priorities[" + pos + "] " + priorities[pos]);
...
//                                .get(pos).length())) {
        ...
        Log.d("Test", "Suggest addword mSuggestions[" + pos + "] " + sb);
